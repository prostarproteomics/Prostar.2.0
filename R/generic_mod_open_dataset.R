...
#' @import shiny
#' 
generic_mod_open_dataset_ui <- function(id){
  ns <- NS(id)
  tagList(
    h3('Generic mod open dataset module')
  )
}
...
#' 
generic_mod_open_dataset_server <- function(id){
...
ui <- generic_mod_open_dataset_ui("qf_file")


server <- function(input, output, session) {
  generic_mod_open_dataset_server("qf_file")
